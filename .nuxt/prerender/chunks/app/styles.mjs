...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.399f3ef0.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.2392087a.mjs').then(interopDefault),
