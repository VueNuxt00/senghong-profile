import { reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, toRef as toRef$1, defineComponent, computed, ref, h, resolveComponent, nextTick, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, openBlock, createElementBlock, createElementVNode, warn, watch, mergeProps, renderSlot, useSlots, Text, createBlock, resolveDynamicComponent, withCtx, Fragment, normalizeClass, createCommentVNode, provide, readonly, customRef, getCurrentScope, onScopeDispose, watchEffect, createTextVNode, toDisplayString, createVNode, useSSRContext, Suspense, Transition, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
    ...
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import("./_nuxt/flutter-cd28372e.js").then((m) => m.default || m)
      },
      {
        name: "index",
        path: "",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-4fc287a7.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-94060fdf.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-d296d3cc.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
