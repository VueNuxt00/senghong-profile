...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full p-4 flex justify-start space-x-2 items-start dark:text-white relative" }, _attrs))}><div class="flex flex-col space-y-4 dark:bg-gray-800 bg-gray-200 w-[200px] p-2 rounded-md sticky top-0"><!--[-->`);
...
//# sourceMappingURL=index-63e25120.mjs.map
